...
RELATIVE_PATHS=(
  ...
  "scib_metrics_panel_plot/breast/breast/lognorm/scib_metrics_Leiden_ARI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.pdf"

  "scib_metrics_panel_plot/breast/breast/lognorm/scib_metrics_iLISI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.pdf"

  # contamination logreg boxplots
  "contamination_metrics_diffexpr_radius=15_n_permutations=30_n_splits=5_top_n=20_precision_spatial_specificity_logreg_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_contaminated_by_malignant_cell_importances_n_hits_top_n=20.pdf"

  # contamination diffexpr boxplots
  "contamination_metrics_diffexpr_radius=15_top_n=20_specificity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_contaminated_by_malignant_cell_logfoldchanges_n_hits_top_n=20.pdf"

  # summary stats
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_median_n_genes.pdf"
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_n_cells.pdf"
  "contamination_metrics_cosine_similarity_scrnaseq_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_cosine_similarity.pdf"

  # gsea heatmaps
  "heatmap_diffexpr_gsea/heatmap_ref_condition='breast'_ref_panel='breast'_ref_segmentation='5µm'.pdf"
  "heatmap_diffexpr_gsea/heatmap_ref_condition='breast'_ref_panel='breast'_ref_segmentation='ProSeg'.pdf"
