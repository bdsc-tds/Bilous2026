...
RELATIVE_PATHS=(
  ...
  "scib_metrics_panel_plot/NSCLC/5k/lognorm/scib_metrics_Leiden_ARI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.pdf"
  "scib_metrics_panel_plot/NSCLC/lung/lognorm/scib_metrics_Leiden_ARI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.pdf"

  "scib_metrics_panel_plot/NSCLC/5k/lognorm/scib_metrics_iLISI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.pdf"
  "scib_metrics_panel_plot/NSCLC/lung/lognorm/scib_metrics_iLISI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.pdf"

  # contamination logreg boxplots
  "contamination_metrics_diffexpr_radius=15_n_permutations=30_n_splits=5_top_n=20_precision_spatial_specificity_logreg_boxplot/NSCLC/lung/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/lung_T_cell_contaminated_by_malignant_cell_importances_n_hits_top_n=20.pdf"
  "contamination_metrics_diffexpr_radius=15_n_permutations=30_n_splits=5_top_n=20_precision_spatial_specificity_logreg_boxplot/NSCLC/5k/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/5k_T_cell_contaminated_by_malignant_cell_importances_n_hits_top_n=20.pdf"

  # contamination diffexpr boxplots
  "contamination_metrics_diffexpr_radius=15_top_n=20_specificity_boxplot/NSCLC/lung/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/lung_T_cell_contaminated_by_malignant_cell_logfoldchanges_n_hits_top_n=20.pdf"
  "contamination_metrics_diffexpr_radius=15_top_n=20_specificity_boxplot/NSCLC/5k/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/5k_T_cell_contaminated_by_malignant_cell_logfoldchanges_n_hits_top_n=20.pdf"

  # summary stats
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/NSCLC/lung/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/lung_median_n_genes.pdf"
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/NSCLC/lung/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/lung_n_cells.pdf"
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/NSCLC/5k/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/5k_median_n_genes.pdf"
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/NSCLC/5k/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/5k_n_cells.pdf"
  "contamination_metrics_cosine_similarity_scrnaseq_boxplot/NSCLC/lung/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/lung_T_cell_cosine_similarity.pdf"
  "contamination_metrics_cosine_similarity_scrnaseq_boxplot/NSCLC/5k/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/5k_T_cell_cosine_similarity.pdf"

  # gsea heatmaps
  "heatmap_diffexpr_gsea/heatmap_ref_condition='NSCLC'_ref_panel='lung'_ref_segmentation='5µm'.pdf"
  "heatmap_diffexpr_gsea/heatmap_ref_condition='NSCLC'_ref_panel='lung'_ref_segmentation='ProSeg'.pdf"

  # count correction palette
  "palettes/col_palette_correction_method_count_correction_legend_vertical.pdf"
  "palettes/col_palette_correction_method_count_correction_legend_horizontal.pdf"
