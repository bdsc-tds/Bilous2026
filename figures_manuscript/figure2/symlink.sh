...
RELATIVE_PATHS=(
  ...
  "embed_panel_restricted_genes_and_samples_scrnaseq/Xenium_NSCLC_5k_lung_chromium_common_genes/matched_lung_standard/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.png"
