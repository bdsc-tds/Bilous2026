...
RELATIVE_PATHS=(
  ...
  "embed_panel_restricted_genes_and_samples/10x_5um/NSCLC/lung/lognorm/umap_data_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "embed_panel_restricted_genes_and_samples/10x_mm_5um/NSCLC/5k/lognorm/umap_data_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"

  # chromium common genes UMAP
  "embed_panel_restricted_genes_scrnaseq/Xenium_NSCLC_5k_lung_chromium_common_genes/matched_combo_standard_lung_specific/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.csv"
...
ABSOLUTE_PATHS=(
  ...
  # "/work/PRTNR/CHUV/DIR/rgottar1/spatial/env/mbilous/Git/xenium_data_analysis/paper_figures/plots/Figure_2/correlation_5k_lung_mean_gene_expr_matched.csv"
  
  # xenium 5K vs Chromiun and Xenium Lung vs chromium mean gene expression per cell type, shared genes, sample 0PSV
  # "/work/PRTNR/CHUV/DIR/rgottar1/spatial/env/mbilous/Git/xenium_data_analysis/paper_figures/plots/Figure_2/selected_celltype_correlation_mean_gene_expr_5k_lung_chromium_0PSV.csv"
  # xenium 5K vs Chromiun and Xenium Lung vs chromium mean gene expression per cell type, shared genes, sample 1G73
  # "/work/PRTNR/CHUV/DIR/rgottar1/spatial/env/mbilous/Git/xenium_data_analysis/paper_figures/plots/Figure_2/selected_celltype_correlation_mean_gene_expr_5k_lung_chromium_1G73.csv"
