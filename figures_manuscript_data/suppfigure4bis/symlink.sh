...
RELATIVE_PATHS=(
  # umaps breast 5um
  "embed_panel/10x_5um/breast/breast/lognorm/umap_data_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "resolvi_panel_use_batch=True_embed_panel/10x_5um/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "resolvi_panel_supervised_use_batch=True_embed_panel/10x_5um/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "ovrlpy_correction_signal_integrity_threshold=0.5_embed_panel/10x_5um/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "split_fully_purified_embed_panel_matched_reference_combo/10x_5um/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  
  # umaps breast proseg
  "embed_panel/proseg_expected/breast/breast/lognorm/umap_data_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "resolvi_panel_use_batch=True_embed_panel/proseg_expected/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "resolvi_panel_supervised_use_batch=True_embed_panel/proseg_expected/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "ovrlpy_correction_signal_integrity_threshold=0.5_embed_panel/proseg_expected/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  "split_fully_purified_embed_panel_matched_reference_combo/proseg_expected/breast/breast/lognorm/umap_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  
  # bio/batch conservation barplots
  "scib_metrics_panel_plot/breast/breast/lognorm/scib_metrics_Leiden_ARI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.csv"

  "scib_metrics_panel_plot/breast/breast/lognorm/scib_metrics_iLISI_data_matched_reference_combo_rctd_class_aware_Level2.1_n_comps=50_max_n_cells=100000.csv"

  # contamination logreg boxplots
  "contamination_metrics_diffexpr_radius=15_n_permutations=30_n_splits=5_top_n=20_precision_spatial_specificity_logreg_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_contaminated_by_malignant_cell_importances_n_hits_top_n=20.csv"

  # contamination diffexpr boxplots
  "contamination_metrics_diffexpr_radius=15_top_n=20_specificity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_contaminated_by_malignant_cell_logfoldchanges_n_hits_top_n=20.csv"

  # summary stats
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_median_n_genes.csv"
  "contamination_metrics_diffexpr_radius=15_top_n=20_sensitivity_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_n_cells.csv"
  "contamination_metrics_cosine_similarity_scrnaseq_boxplot/breast/breast/lognorm/data_matched_reference_combo_rctd_class_aware_Level2.1/breast_T_cell_cosine_similarity.csv"

  # gsea heatmaps
  "heatmap_diffexpr_gsea/heatmap_ref_condition='breast'_ref_panel='breast'_ref_segmentation='5µm'.csv"
  "heatmap_diffexpr_gsea/heatmap_ref_condition='breast'_ref_panel='breast'_ref_segmentation='ProSeg'.csv"
