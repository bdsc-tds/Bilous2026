...
RELATIVE_PATHS=(
  ...
  "embed_panel/10x_5um/NSCLC/chuvio/lognorm/umap_data_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_matched_reference_combo_rctd_class_aware_Level2.1.csv"
  ...
  # chromium umap
  "embed_panel_scrnaseq_joint/matched_combo_standard_lung_specific_matched_combo_standard_breast_specific/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.csv"
