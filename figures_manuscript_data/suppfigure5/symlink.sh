...
RELATIVE_PATHS=(
  # umaps
  "embed_panel_restricted_genes_scrnaseq/Xenium_hBreast_v1_metadata/matched_combo_standard_breast_specific/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.csv"
  "embed_panel_restricted_genes_scrnaseq/Xenium_hLung_v1_metadata/matched_combo_standard_lung_specific/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.csv"
  "embed_panel_restricted_genes_scrnaseq/CHUV_IO_340_panel/matched_combo_standard_lung_specific/umap_RNA_counts_n_comps=50_n_neighbors=50_min_dist=0.5_euclidean_Level2.1.csv"
